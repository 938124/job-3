...
-- Pattern: SELECT source columns AS silver snake_case names
--          FROM ${bronze_catalog}.atlas.{TableName}
--          WHERE IS_DELETED = false
-- Audit columns (audit_etl_id, audit_create_date, audit_update_date,
--                audit_is_deleted) are added by Job_ATLAS_SILVER, not here.
-- ============================================================


-- ============================================================
-- View: atlas_stage.BPC_Plug_Financials
-- Source: ${bronze_catalog}.atlas.BPC_Plug_Financials
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.BPC_Plug_Financials_MachineCosts
-- Source: ${bronze_catalog}.atlas.BPC_Plug_Financials_MachineCosts
-- Note: No SQL DDL source file found; column names derived from silver DDL
--       back-converted to Title Case. The silver DDL describes a pivoted
--       output written by Job_ATLAS_SILVER; the staging view selects the
--       raw bronze columns using their original names.
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.BW_COPA_DailyFeePoker_Units
-- Source: ${bronze_catalog}.atlas.BW_COPA_DailyFeePoker_Units
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.BW_ZRBINQ_BillingPlans
-- Source: ${bronze_catalog}.atlas.BW_ZRBINQ_BillingPlans
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.GameOpsInstallBaseActivity
-- Source: ${bronze_catalog}.atlas.GameOpsInstallBaseActivity
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.GameOpsInstallBasePSD
-- Source: ${bronze_catalog}.atlas.GameOpsInstallBasePSD
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Exp_Depreciation
-- Source: ${bronze_catalog}.atlas.RPM_Exp_Depreciation
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Intl_Performance_EMEA_Africa
-- Source: ${bronze_catalog}.atlas.RPM_Intl_Performance_EMEA_Africa
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Intl_Performance_EMEA_FixedFee
-- Source: ${bronze_catalog}.atlas.RPM_Intl_Performance_EMEA_FixedFee
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Intl_Performance_EMEA_GreeceWLA
-- Source: ${bronze_catalog}.atlas.RPM_Intl_Performance_EMEA_GreeceWLA
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Intl_Performance_LAC
-- Source: ${bronze_catalog}.atlas.RPM_Intl_Performance_LAC
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Peformance_PremLotto_DE
-- Source: ${bronze_catalog}.atlas.RPM_Peformance_PremLotto_DE
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Peformance_PremLotto_NY
-- Source: ${bronze_catalog}.atlas.RPM_Peformance_PremLotto_NY
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Peformance_PremLotto_RI
-- Source: ${bronze_catalog}.atlas.RPM_Peformance_PremLotto_RI
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Performance_CDS_Class_II
-- Source: ${bronze_catalog}.atlas.RPM_Performance_CDS_Class_II
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Performance_CDS_Class_II_ManualBilling
-- Source: ${bronze_catalog}.atlas.RPM_Performance_CDS_Class_II_ManualBilling
-- ============================================================
...
-- ============================================================
-- View: atlas_stage.RPM_Performance_WAP_NewCanada
-- Source: ${bronze_catalog}.atlas.RPM_Performance_WAP_NewCanada
-- ============================================================
